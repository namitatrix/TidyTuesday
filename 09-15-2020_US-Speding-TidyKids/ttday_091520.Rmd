...
```{r}
# Which state spends the most on which sector?
kids %>% 
  group_by(state) %>% 
...
Working on while watching Robinson live cast:
```{r}
...
Key takeaways:
1. DC has some of the highest spending on public health which seems to have been cut down since 2009. Vermont has an increased spending in public health, whereas most other states don't see much of a growth.
