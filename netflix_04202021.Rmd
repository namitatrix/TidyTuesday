...
geom_text_wordcloud() +
  ...
  scale_y_continuous(breaks = NULL) +
   labs(x = " ", y = " ", title = "Words used to describe Indian content on Netflix over time", 
        subtitle = "Year content was added to Netflix | Top 10 most frequent words in descriptions \n",
